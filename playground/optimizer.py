...
class PathPlanner():
    ...
    def set_constraints(self) -> None:
        ...
        #constraints.append(self.curr_velocity[0, :] < 2)
        #constraints.append(self.curr_velocity[1, :] < 2)
        #constraints.append(self.curr_velocity[2, :] < 2)
    ...
    def set_obstacle_constraints(self) -> None:
        ...
        for j, obstacle in enumerate(self.obstacles):
            for i in range(2, self.N):
                distance_from_obstacle = self.prev_position[:, i] - obstacle["position"]
                dposition = position_trajectory[i] - self.prev_position[:, i]
