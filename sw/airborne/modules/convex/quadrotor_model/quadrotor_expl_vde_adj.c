...
static const casadi_int casadi_s3[10] = {16, 1, 0, 6, 3, 4, 5, 12, 13, 14};

/* quadrotor_expl_vde_adj:(i0[12],i1[12],i2[4],i3[3])->(o0[16x1,6nz]) */
static int casadi_f0(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  casadi_real *w0=w+0, *w1=w+12, *w2=w+15;
  /* #0: @0 = input[1][0] */
